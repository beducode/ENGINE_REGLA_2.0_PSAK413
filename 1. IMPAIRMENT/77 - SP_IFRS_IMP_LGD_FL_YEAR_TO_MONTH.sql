---- DROP PROCEDURE SP_IFRS_IMP_LGD_FL_YEAR_TO_MONTH;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_LGD_FL_YEAR_TO_MONTH(
...
BEGIN 
    ...
    LEFT JOIN ' || V_TABLEINSERT5 || ' F ON B.PD_MODEL_ID = F.PD_RULE_ID AND B.EFF_DATE = F.EFFECTIVE_DATE AND C.FL_YEAR = F.FL_YEAR AND C.FL_MONTH = F.FL_MONTH  
    ...
    RAISE NOTICE 'SP_IFRS_IMP_LGD_FL_YEAR_TO_MONTH | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======
    ...
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_LGD_FL_YEAR_TO_MONTH';
    V_OPERATION = 'INSERT';
