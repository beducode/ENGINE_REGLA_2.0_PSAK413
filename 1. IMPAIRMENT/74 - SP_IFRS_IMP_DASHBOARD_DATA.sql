...
BEGIN 
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT1 || ' 
        (  
            ...
            ,SUM(COALESCE(CASE WHEN IMPAIRED_FLAG=''C'' THEN EIL_AMOUNT ELSE 0 END,0)*COALESCE(EXCHANGE_RATE,1)) AS CA_ECL_AMT_IDR
            ,SUM(COALESCE(CASE WHEN IMPAIRED_FLAG=''I'' THEN EIL_AMOUNT ELSE 0 END,0)*COALESCE(EXCHANGE_RATE,1)) AS IA_ECL_AMT_IDR
            ,SUM(COALESCE(EIL_AMOUNT,0)*COALESCE(EXCHANGE_RATE,1)) AS ECL_AMT_IDR
