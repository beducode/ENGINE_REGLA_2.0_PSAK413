---- DROP PROCEDURE SP_IFRS_IMP_ECL_UPDATE_PORTFOLIO;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_ECL_UPDATE_PORTFOLIO(
...
BEGIN 
    ...
    V_STR_QUERY := '';
    V_STR_QUERY := V_STR_QUERY || '
        DELETE FROM IFRS_EXCEPTION_ACCOUNT
    ...
    LOOP
        ...
        V_STR_QUERY := V_STR_QUERY || '
            ...
            SET SUB_SEGMENT = ''' || V_RECORD.SUB_SEGMENT || ''',
                SEGMENT = ''' || V_RECORD.SEGMENT || ''',
                GROUP_SEGMENT = ''' || V_RECORD.GROUP_SEGMENT || '''
    ...
    RAISE NOTICE 'SP_IFRS_IMP_ECL_UPDATE_PORTFOLIO | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLENAME;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_ECL_UPDATE_PORTFOLIO';
    V_OPERATION = 'UPDATE';
