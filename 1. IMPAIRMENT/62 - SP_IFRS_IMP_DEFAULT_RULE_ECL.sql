---- DROP PROCEDURE SP_IFRS_IMP_DEFAULT_RULE_ECL;

CREATE OR REPLACE PROCEDURE SP_IFRS_IMP_DEFAULT_RULE_ECL(
...
BEGIN 
    ...
    RAISE NOTICE 'SP_IFRS_IMP_DEFAULT_RULE_ECL | AFFECTED RECORD : %', V_RETURNROWS2;
    -------- ====== BODY ======

    -------- ====== LOG ======
    V_TABLEDEST = V_TABLEINSERT2;
    V_COLUMNDEST = '-';
    V_SPNAME = 'SP_IFRS_IMP_DEFAULT_RULE_ECL';
    V_OPERATION = 'INSERT';
