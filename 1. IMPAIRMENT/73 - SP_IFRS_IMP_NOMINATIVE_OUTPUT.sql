...
BEGIN 
    ...
    V_STR_QUERY := V_STR_QUERY || 'INSERT INTO ' || V_TABLEINSERT1 || ' 
        (          
            ...
            ,MARGIN_RATE AS INT_RATE          
            ,EIR AS EIR_RATE          
            ,COALESCE(EXCHANGE_RATE, 1) AS EXCHANGE_RATE          
            ,BI_COLLECTABILITY AS COLLECT          
            ,IMPAIRED_FLAG AS CKPN_TYPE          
            ,COALESCE(EIL_AMOUNT,0) AS CKPN_ORI          
            ,COALESCE(EIL_AMOUNT,0) * COALESCE(EXCHANGE_RATE, 1) AS CKPN_LEV          
            ...
            ,BUCKET_NAME    
            ,DPD_FINAL   
            ,COALESCE(EIL_AMOUNT,0)  - COALESCE(IA_UNWINDING_AMOUNT,0)  AS CKPN_ORI_NET  
            ,(COALESCE(EIL_AMOUNT,0)*COALESCE(EXCHANGE_RATE, 1) ) - (COALESCE(IA_UNWINDING_AMOUNT,0)*COALESCE(EXCHANGE_RATE, 1)) AS  CKPN_LEV_NET               
